class Commenttown < ApplicationRecord
  ...
  def self.commenttowns_by_state(state,page, per_page = 10)
  ...
  def self.commenttowns_by_depart(depart,page, per_page = 10)
  ...
  def self.commenttowns_by_user(user,page, per_page = 10)
